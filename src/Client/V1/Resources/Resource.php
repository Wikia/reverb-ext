...
use Reverb\Client\V1\Exceptions\ResourceAlreadyPopulated;
use Reverb\Client\V1\Exceptions\ResourceAttributeUndefined;
use Reverb\Client\V1\Exceptions\ResourceRelationshipUndefined;
...
abstract class Resource {
	 ...
	 * @var string
	 */
	public const RELATIONSHIP_ONE = 'toOne';
	 ...
	 * @var string
	 */
	public const RELATIONSHIP_MANY = 'toMany';
	...
	public function __construct( ?array $values = null ) {
		...
		$this->relations = ( new Collection( $this->relationships ) )->map( static function () {
	 ...
	 *
	 * @return mixed
	 * @throws \Reverb\Client\V1\Exceptions\ResourceAttributeUndefined
	 *
	 */
	 ...
	 *
	 * @return \Tightenco\Collect\Support\Collection|\Reverb\Client\V1\Resource|null
	 * @throws \Reverb\Client\V1\Exceptions\ResourceRelationshipUndefined
	 *
	 */
	 ...
	 * @param array $values
	 *
	 * @return \Reverb\Client\V1\Resource
	 */
	 ...
	 *
	 * @return \Reverb\Client\V1\Resource
	 * @throws \Reverb\Client\V1\Exceptions\ResourceAlreadyPopulated
	 *
	 */
	...
	public function setRelations( array $relations ): self {
		...
		} )->map( static function ( $collection, $relationship ) use ( $relations ) {
	 ...
	 *
	 * @param string $relationship
	 * @param \Reverb\Client\V1\Resource ...$resources
	 *
	 * @return \Reverb\Client\V1\Resource
	 * @throws \Reverb\Client\V1\Exceptions\ResourceRelationshipUndefined
	 *
	...
	protected function getFilledRelationships(): array {
		return $this->relations->map( static function ( $resources ) {
			return $resources->reject( static function ( $resource ) {
		...
		} )->reject( static function ( $resources ) {
	 ...
	 * @param string $relationship
	 *
	 * @return \Reverb\Client\V1\Resource|null
	 */
