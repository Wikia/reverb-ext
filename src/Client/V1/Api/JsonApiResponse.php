...
class JsonApiResponse {
	 ...
	 *
	 * @var \Reverb\Client\V1\Api\Document|null
	 */
	protected $document;
	 ...
	 * @param \Reverb\Client\V1\Api\Document|null $document
	 */
	 ...
	 *
	 * @return \Reverb\Client\V1\Api\Document
	 */
	...
	public function isSuccessfulUpdate(): bool {
		return $this->isSuccessfulUpdateWithDocument() || $this->isSuccessfulUpdateWithoutDocument();
	}
